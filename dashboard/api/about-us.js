$(function () {
  ...
  $(document).on("click", ".view_item", function () {
    let uri = "http://localhost:81/task27_1/api/about";
    fetch(uri)
      .then((response) => response.json())
      .then((data) => {
        /*html*/
  ...
  $(document).on("submit", "#create_form", function (e) {
    ...
    fetch("http://localhost:81/task27_1/api/about/create", {
      method: "POST",
      body: formData,
    }).then((res) => {
      if (res.ok) {
  ...
  $(document).on("submit", "#update_form", function (e) {
    ...
    // Send data to backend
    fetch("http://localhost:81/task27_1/api/about/update/" + formData["id"], {
      method: "POST",
      body: formData,
    }).then((res) => {
      if (res.ok) {
  ...
  $(document).on("click", ".delete_item", function () {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch("http://localhost:81/task27_1/api/about/delete/" + id, {
          method: "POST",
        })
          .then((respon) => {
