$(function () {
  ...
  function getAll() {
    ...
    fetch("http://localhost:81/task27_1/api/users?limit=1000")
  ...
  $(document).on("submit", "#create_form", function (e) {
    ...
    fetch("http://localhost:81/task27_1/api/users/create", {
      method: "POST",
      headers: {
  ...
  $(document).on("click", ".update_item", function () {
    ...
    let uri = "http://localhost:81/task27_1/api/users/details/" + id;
    fetch(uri)
      .then((response) => response.json())
      .then((data) => {
        /*html*/
  ...
  $(document).on("submit", "#update_form", function (e) {
    ...
    // Send data to backend
    fetch("http://localhost:81/task27_1/api/users/update/" + formData["id"], {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  $(document).on("click", ".delete_item", function () {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch("http://localhost:81/task27_1/api/users/delete/" + id, {
          method: "POST",
        })
          .then((respon) => {
